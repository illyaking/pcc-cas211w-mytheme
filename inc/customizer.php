...
//Theme Customizer- Modify Home Page
    ...
    // Control/Setting for Third Area
        $wp_customize->add_setting( 'contact_form_area' );

        $wp_customize->add_control( 'contact_form_area', array(
                'type'        =>  'checkbox',
                'priority'    => 30,
                'section'     => 'custom_home_section',
                'label'       => __( 'Check to Remove the Contact Form', 'illyaking' ),
                'description' => '',
        ) );
    ...
    // Theme Customizer - Social Icons
        $wp_customize->add_section( 'social_icons_section', array(
                'title'           => __( 'Social Icons', 'illyaking' ),
                'description'     => __( 'Add your social media URLs to each field below to display their related social icons in the footer.', 'illyaking' ),
                'priority'        => 100,
        ) );
        ...
        $wp_customize->add_control( 'facebook_url', array(
                ...
                'label'       => __( 'Facebook URL', 'illyaking' ),
                'description' => __( 'Enter the complete address, including the https://', 'illyaking' ),
        ) );
        ...
        $wp_customize->add_control( 'instagram_url', array(
                ...
                'priority'    => 10,
                'section'     => 'social_icons_section',
                'label'       => __( 'Instagram URL', 'illyaking' ),
                'description' => __( 'Enter the complete address, including the https://', 'illyaking' ),
        ) );
    ...
    // Control/Setting for Linkedin Link
        ...
        $wp_customize->add_control( 'linkedin_url', array(
                ...
                'priority'    => 10,
                'section'     => 'social_icons_section',
                'label'       => __( 'Linkedin URL', 'illyaking' ),
                'description' => __( 'Enter the complete address, including the https://', 'illyaking' ),
        ) );
    
        // Control/Setting for Tumblr Link
        ...
        $wp_customize->add_control( 'twitter_url', array(
                ...
                'priority'    => 10,
                'section'     => 'social_icons_section',
                'label'       => __( 'Twitter URL', 'illyaking' ),
                'description' => __( 'Enter the complete address, including the https://', 'illyaking' ),
        ) );

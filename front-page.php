...
<main>
    ...
    <div class="container-fluid marketing">
        ...
        <div class="row featurette secondary">
            <div class="col-md-7 col-md-push-5">
                <h2 class="featurette-heading"><?php echo get_theme_mod( 'secondary_title', 'Oh yeah, its that good' ); ?></h2>
                <p class="lead"><?php echo get_theme_mod( 'secondary_statement', 'Porta nibh venenatis cras sed felis eget velit aliquet. Velit scelerisque in dictum non consectetur a erat nam at. Accumsan sit amet nulla facilisi morbi tempus. Sem nulla pharetra diam sit amet. Aliquet sagittis id consectetur purus ut faucibus pulvinar elementum.' ); ?></p>
            </div> <!-- /.col-md-7 -->
            <div class="col-md-5 col-md-pull-7">
                <?php if ( get_theme_mod( 'secondary_image') ) : ?>
                <img class="featurette-image img-responsive" style="float: right;" data-src="holder.js/500x500/auto" alt="500x500" src="<?php echo get_theme_mod( 'secondary_image'); ?> ">
                <?php else : ?>
        ...
        <div class="row featurette triad">
            <div class="col-md-7">
                <h2 class="featurette-heading"><?php echo get_theme_mod( 'triad_title', 'And lastly, this one' ); ?></h2>
                <p class="lead"><?php echo get_theme_mod( 'triad_statement', 'Porta nibh venenatis cras sed felis eget velit aliquet. Velit scelerisque in dictum non consectetur a erat nam at. Accumsan sit amet nulla facilisi morbi tempus. Sem nulla pharetra diam sit amet. Aliquet sagittis id consectetur purus ut faucibus pulvinar elementum.' ); ?></p>
            </div><!-- /.col-md-7 -->
            <div class="col-md-5 col-md-pull-7">
    ...
    <?php if (!get_theme_mod('contact_form_area')) : ?>
    <section id="contact">
        <div class="container-fluid tetrad">
            <div class="col-md-12">

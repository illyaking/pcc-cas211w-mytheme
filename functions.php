...
function illyaking_scripts() {
    ...
    wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/fontawesome-free-5.11.2-web/css/all.min.css' );
...
function create_post_type() {
  register_post_type( 'illya_product',
      array(
         'labels' => array(
            'name' => __( 'Products' ),
...
<style type="text/css">
    body.login {
        background: url('https://illyaking.com/data/uploads/2018/05/floral-pattern-wallpaper-black-1600x1200a.jpg');
    }

    #login h1 a,
    .login h1 a {
        background-image: url('https://illyaking.com/data/uploads/2019/05/Illya-King-Site-Id-01b.png');
        height: 150px;
        width: 150px;
...
function illyaking_customizer_style() {
    wp_add_inline_style( 'customize-controls', '.wp-full-overlay-sidebar { background: #cfc20f;}' , '.description { color: #000000;}');
}
